            ...
            <div class="sub-page">
                ...
                <div class="main-content">
                    ...
                    <div class="row letter-address" style="margin-bottom:0;">
                        <div class="col-12">
                            ...
                            @if($transfer->employee->designation_id == 22)
                                <p>{{$transfer->employee->designation->designation}}</p>
                            @else
                    ...
                    <div class="row letter-content">
                        <div class="col-12">
                            <h6 class="font-weight-bold" style="margin-bottom:0;"> @if($transfer->transfer_type == 3) வருடாந்த ஆசிரியர் இடமாற்றம்-{{Carbon\Carbon::now()->format('Y')}}  @elseif($transfer->transfer_type == 0) பாடசாலையின் தேவை கருதிய இடமாற்றம் @elseif($transfer->transfer_type == 1) பாடசாலையின் தேவை கருதிய தற்காலிக இடமாற்றம் @elseif ($transfer->transfer_type == 2) பாடசாலையின் தேவை கருதிய இரண்டு நாள் பணிமாற்றம் @elseif($transfer->transfer_type == 4) தற்காலிக இடமாற்றம் @elseif($transfer->transfer_type == 5) தற்காலிக இடமாற்றம் (மகப்பேறு) @elseif($transfer->transfer_type == 6) நிரந்தர இடமாற்றம் @endif</h6><br>
                            <p>@if($transfer->transfer_type == 3) மேற்படி வலயத்திற்குள்ளான அனைத்து ஆசிரியர் சங்கங்களையும் உள்ளடக்கியதான வருடாந்த ஆசிரியர் இடமாற்ற தீர்மானத்தின் பிரகாரம் தங்களுக்கு @elseif($transfer->transfer_type == 4 || $transfer->transfer_type == 6) தங்களது கோரிக்கையின் நியாயத்தன்மையினை கருத்தில்கொண்டு @elseif($transfer->transfer_type == 5) தங்களது கோரிக்கைக்கு அமைவாக தங்களது மகப்பேற்று காரணத்தினை கருத்தில்கொண்டு @else பாடசாலையின் அவசிய தேவை கருதி தங்களுக்கு  @endif @if (is_null($transfer->effect_from)) உடன் செயற்படும் வண்ணம் @else {{date('d-m-Y', strtotime($transfer->effect_from))}} திகதி முதல் செயற்படும் வண்ணம் @endif @if ($transfer->transfer_type == 2)மறு அறிவித்தல் வரை வாரத்திற்கு இரண்டு நாட்களுக்கு @elseif ($transfer->transfer_type == 4 || $transfer->transfer_type == 1) மறு அறிவித்தல் வரை @elseif($transfer->transfer_type == 5) மகப்பேற்று விடுமுறை காலம் நிறைவடையும் @endif கீழ்வரும் பாடசாலைக்கு @if($transfer->transfer_type == 1 || $transfer->transfer_type == 4 || $transfer->transfer_type == 5) தற்காலிகமாக இடமாற்றம் வழங்கப்படுகின்றது. 
                            @elseif($transfer->transfer_type == 2)கடைமையாற்ற பணிக்கப்படுகின்றீர்கள். @else இடமாற்றம் வழங்கப்படுகின்றது @endif</p>                        
                            ...
                            <p>@if($transfer->transfer_type == 0 || $transfer->transfer_type == 1 || $transfer->transfer_type == 2) குறித்த இடமாற்றம் தொடர்பாக தங்களுக்கு மேன்முறையீடுகள் எதும் இருப்பின் 14 நாட்களுக்குள் விண்ணப்பிக்க முடியும் என்பதுடன் இவ் இடமாற்றத்திற்காக தங்களுக்கு போக்குவரத்து கொடுப்பனவுகள் ஏதும் வழங்கப்பட மாட்டாது.@endif</p> 
                            <p>@if($transfer->transfer_type == 3) இவ் இடமாற்றத்திற்காக தங்களுக்கு போக்குவரத்து கொடுப்பனவுகள் ஏதும் வழங்கப்பட மாட்டாது.@endif</p> 
                        </div>
                    </div>
                    <div class="row signature-div float-left">
                        <div class="col-12">
                            <!--@if($transfer->is_approved == 1 && ($transfer->employee->institute1->pfclerk->id == Auth::user()->id || Auth::user()->id == 2))-->
